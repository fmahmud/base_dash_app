...
class AsyncDemoView(BaseView):
    ...
    def handle_any_input(self, *args, triggering_id, index):
        ...
        return [AsyncDemoView.raw_render(self.async_groups)]

    @staticmethod
    def raw_render(async_groups: List[AsyncOrderedTaskGroup]):
        ...
        return html.Div(
            children=[
                ...
                *([
                    ag.render()
                    for ag in async_groups if ag is not None
    ...
    def render(self, *args, **kwargs):
        return html.Div(
            ...
            children=AsyncDemoView.raw_render(self.async_groups)
        )